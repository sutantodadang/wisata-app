    ...
    <main class="container mx-auto pt-4 px-4 md:px-6 lg:px-8">
        ...
        <section>
            ...
            <div v-if="activeTab == 0">
                ...
                <div v-if="Object.keys(store.groupedAvailabilityByRoomName).length === 0" class="py-10 text-gray-900">
                ...
                <section v-else>
                    <div class="flex items-center justify-center gap-3 text-gray-800 py-10">
                        ...
                        <UButton
                            ...
                            v-if="activeFilters.length > 0" @click="toggleFilter('')" variant="outline" class="">Clear
                        ...
                        <UButton @click="toggleFilter('cancel')" label="Free Cancellation" variant="ghost"
                            ...
                            icon="i-material-symbols:credit-score-outline" class="rounded-xl font-semibold border" />
                    </div>
                                        ...
                                        <div class="grid grid-cols-3 gap-1 justify-center pt-1 items-center">
                                            <div v-for="(image, index) in store.groupedImagesByRoomName[bedGroup]"
                                                ...
                                                <div v-if="index < 3" class="relative w-24 h-24">
                                                    <NuxtImg :src="store.groupedImagesByRoomName[bedGroup][index + 1]"
                                    ...
                                    <div
                                        ...
                                        <div v-for="offer in offers" :key="offer.offer_id" class="overflow-hidden ">
                                            ...
                                            <div class="p-7 border-b border-gray-200">
                                                <div class="flex flex-row items-center justify-between">
                                                    ...
                                                    <div>
                                                        ...
                                                        <UTooltip text="Screenshot offer"
                                                            ...
                                                            <UButton icon="i-mdi:line-scan" variant="ghost" color="gray"
                                                                @click="handleModalButton(offer)" />
                                                        </UTooltip>
                                                        <UTooltip text="See all action" :popper="{ placement: 'top' }">
                                                            <UButton icon="i-mdi:dots-horizontal" variant="ghost"
                                                                color="gray" />
                                                        </UTooltip>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div>
                                                        <h4>Rp {{ formatRate(offer.pricing_data.rate_nightly.toString())
                                                            }}
                                                            /
                                                        ...
                                                        <p class="text-gray-500">Total · Rp {{
                                                            formatRate(offer.pricing_data.price_total.toString()) }}</p>
                ...
                <div class="flex flex-col md:flex-row justify-center">
                    <section class="w-full md:w-96 h-full">
                        ...
                        <div v-if="activeTabButton == 1">
                            ...
                            <div class="flex items-start justify-center flex-col bg-gray-100 p-5 w-96 h-96">
